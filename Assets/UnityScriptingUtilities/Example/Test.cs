...
namespace Wrj
{
    public class Test : MonoBehaviour
    {
        ...
        private List<Transform> randomBumpObjects = new List<Transform>();
        void Start()
        {
            randomBumpObjects.Add(weight10);
            randomBumpObjects.Add(weight5);
            randomBumpObjects.Add(weight3);
            randomBumpObjects.Add(weight1);

            Debug.Log(randomBumpObjects.Printable());
